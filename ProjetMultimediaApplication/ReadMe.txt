========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet ProjetMultimediaApplication
========================================================================

AppWizard a créé cette application ProjetMultimediaApplication pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application ProjetMultimediaApplication.


ProjetMultimediaApplication.vcxproj
...
ProjetMultimediaApplication.vcxproj.filters
...
ProjetMultimediaApplication.cpp
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) ProjetMultimediaApplication.pch et un fichier de type précompilé nommé StdAfx.obj.
